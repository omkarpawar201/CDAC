	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6 -> {
				...
				boolean status = eService.assignEmployeeProject(eid, pid);
			...
			case 5 -> {
				...
				boolean status = eService.updateEmployee(id, sal);
